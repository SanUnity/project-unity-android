package com.main.covid.bluetracer.bluetooth
...
class BLEScanner constructor(context: Context, uuid: String, reportDelay: Long) {
    ...
    fun stopScan() {
        ...
        try {
            if (scanCallback != null && BluetracerUtils.isBluetoothAvailable()) { //fixed crash if BT if turned off, stop scan will crash.
